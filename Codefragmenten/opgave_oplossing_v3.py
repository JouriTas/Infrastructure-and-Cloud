...
def bereken_subnets(nw_dec):
  for i in range(4):
    network_decimal = nw_dec + (64 * i) # dus 1e subnet + 0, 2e subnet + 64, 3e subnet + 128, 4e subnet + 192
    print("Het eerste bruikbare IP-adres voor subnet {} is {}".format((i + 1), dec_naar_ip(network_decimal + 1)))
    print("Het laatste bruikbare IP-adres voor subnet {} is {}".format((i + 1), dec_naar_ip(network_decimal + 62)))
