...
def bereken_subnets(nw_dec):
  ...
  subnet1_broadcast_dec = subnet1_network_dec + 63
  subnet2_broadcast_dec = subnet2_network_dec + 63
  subnet3_broadcast_dec = subnet3_network_dec + 63
  subnet4_broadcast_dec = subnet4_network_dec + 63
  print("Het eerste bruikbare IP-adres voor subnet 1 is {}".format(dec_naar_ip(subnet1_network_dec + 1)))
  print("Het laatste bruikbare IP-adres voor subnet 1 is {}".format(dec_naar_ip(subnet1_broadcast_dec - 1)))
  print("Het eerste bruikbare IP-adres voor subnet 2 is {}".format(dec_naar_ip(subnet2_network_dec + 1)))
  print("Het laatste bruikbare IP-adres voor subnet 2 is {}".format(dec_naar_ip(subnet2_broadcast_dec - 1)))
  print("Het eerste bruikbare IP-adres voor subnet 3 is {}".format(dec_naar_ip(subnet3_network_dec + 1)))
  print("Het laatste bruikbare IP-adres voor subnet 3 is {}".format(dec_naar_ip(subnet3_broadcast_dec - 1)))
  print("Het eerste bruikbare IP-adres voor subnet 4 is {}".format(dec_naar_ip(subnet4_network_dec + 1)))
  print("Het laatste bruikbare IP-adres voor subnet 4 is {}".format(dec_naar_ip(subnet4_broadcast_dec - 1)))
